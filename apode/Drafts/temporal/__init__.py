...
from .polarization import polarization_measure, polarization_measure_w
from .concentration import concentration_measure, concentration_measure_w
...
class IneqMeasure:
    ...
    def display(self):
        return self._data  # CHECK THIS, not sure it's
        # the functionality you wanted
