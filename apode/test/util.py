...
def test_measures_poverty(dr2):
    ...
    mlist_p = ['fgt0','fgt1','fgt2',['fgt',1.5],'sen','sst','watts',['cuh',0],['cuh',0.5],'takayama', \
        'kakwani','thon',['bd',2],'hagenaars',['chakravarty',0.5 ]]
...
def test_measures_ineq(dr2):
    list_i = ['rr','dmr','cv','dslog','gini','merhan','piesch','bonferroni',['kolm',0.5],['ratio',0.05],\
        ['ratio',0.2],  ['entropy',0],['entropy',1],['entropy',2],['atkinson',0.5],\
...
def test_measures_welfare(dr2):
    list_w = ['utilitarian','rawlsian','sen','theill','theilt',['isoelastic',0],['isoelastic',1],\
        ['isoelastic',2],['isoelastic',np.Inf]]
